...
public class AppController {
    ...
    public void exportarPdf(HttpSession session, HttpServletResponse response) throws IOException {
        ...
        for (Lancamento l : lancamentos) {
            document.add(new Paragraph(
                l.getDescricao() + " | R$ " + l.getValor() + " | " + l.getDataLancamento()
                    + " | " + l.getTipoLancamento() + " | " + l.getSituacao()));
        }
    ...
    public String novoLancamento(Model model) {
    ...
    public String salvarPerfil(Usuario usuarioAtualizado, HttpSession session) {
        ...
        emailService.enviarEmailSimples(
                ...
                "Perfil Atualizado",
                "Olá " + usuarioAtualizado.getNome() + ", suas informações foram alteradas recentemente.");
